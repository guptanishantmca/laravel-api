...
export default function AuthenticatedLayout({
    ...
    return (
        ...
        <div className="min-h-screen flex flex-col md:flex-row bg-gray-100">
            {/* Sidebar */}
            <div
                className={`fixed inset-y-0 left-0 z-40 w-64 bg-gray-800 text-white transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
                    ...
                    <div className="md:hidden">
                        <div className="space-y-1">
                            <button
                                ...
                                className={`block px-4 py-2 rounded hover:bg-gray-700 ${activeMenu === 'marketplace'
                                        ? ''
                                        : ''
                                    }`}
                            >
                        ...
                        <div className="space-y-1">
                            <button
                                ...
                                className={`block px-4 py-2 rounded hover:bg-gray-700 ${activeMenu === 'my_business'
                                        ? ''
                                        : ''
                                    }`}
                            >
                        ...
                        <div className="space-y-1">
                            <button
                                ...
                                className={`block px-4 py-2 rounded hover:bg-gray-700 ${activeMenu === 'project_management'
                                        ? ''
                                        : ''
                                    }`}
                            >
                        ...
                        <div className="space-y-1">
                            <button
                                ...
                                className={`block px-4 py-2 rounded hover:bg-gray-700 ${activeMenu === 'settings'
                                        ? ''
                                        : ''
                                    }`}
                            >
                ...
                <nav className="bg-white border-b border-gray-200">
                    <div className="px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
                        ...
                        <div className="hidden md:flex h-16 space-x-8">
                            <button
                                onClick={() => setActiveMenu('marketplace')}
                                className={`text-sm font-medium ${activeMenu === 'marketplace'
                            ...
                            <button
                                onClick={() => setActiveMenu('my_business')}
                                className={`text-sm font-medium ${activeMenu === 'my_business'
                                        ? 'text-gray-900 border-b-2 border-indigo-500'
                                        : 'text-gray-500 hover:text-gray-700'
                                    }`}
                            >
                            ...
                            <button
                                onClick={() => setActiveMenu('project_management')}
                                className={`text-sm font-medium ${activeMenu === 'project_management'
                                        ? 'text-gray-900 border-b-2 border-indigo-500'
                                        : 'text-gray-500 hover:text-gray-700'
                                    }`}
                            >
                            ...
                            <button
                                onClick={() => setActiveMenu('settings')}
                                className={`text-sm font-medium ${activeMenu === 'settings'
                                        ? 'text-gray-900 border-b-2 border-indigo-500'
                                        : 'text-gray-500 hover:text-gray-700'
                                    }`}
                            >
